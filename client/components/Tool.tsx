...
export const Tool = (props: IToolProps) => {
  const buttonClasses =
    "text-lg font-bold font-sans mb-2 py-0.5 px-2 rounded bg-blue-200 hover:bg-blue-300";
  return (
    <GraphProvider>
      <div className="flex flex-col max-h-full">
        <div className="flex">
          <Link href="/">
            <button className="text-2xl font-bold font-sans mb-2 hover:underline text-gray-400">
              Methodable
            </button>
          </Link>
